...
import {
  ...
  Paperclip, Building2, CheckCircle, FileDown, Eye, Link2, FilePlus2,
} from 'lucide-react';
import {
...
interface Props {
  ...
  /** Deschide un document de fundamentare nou, completat din referatul asta. */
  onFaFundamentare?: (referatId: string) => void;
}
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      */}
                      ...
                      {/*
                        Fundamentarea spune in mare acelasi lucru ca referatul,
                        la doua zile distanta. Scrisa a doua oara de mana, iese
                        de fiecare data putin altfel decat hartia din care vine.
                      */}
                      {onFaFundamentare && (
                        <button
                          onClick={() => onFaFundamentare(r.id)}
                          className="px-2.5 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-lg text-[11px] font-bold flex items-center gap-1 hover:bg-emerald-100 transition"
                          title="Incepe un document de fundamentare completat din referatul asta"
                        >
                          <FilePlus2 className="w-3 h-3" />Fa fundamentarea
                        </button>
                      )}
                    </div>
