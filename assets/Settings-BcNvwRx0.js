import{i as me,k as m,l as be,u as he,m as Te,n as b,o as Ne,r as ge,p as Ee,q as fe,s as je,j as e,t as Ae,R as S,v as we}from"./index-DPpL8-LF.js";import{a as t,m as J,k as h,d as ve,t as W,T as K,s as Le,a8 as Se,a9 as Ce,a6 as Ie,aa as ke,ab as V,ac as Oe,J as De,P as Re,u as ye,ad as Xe,o as G,A as Ue}from"./vendor-icons-CvD4Hwck.js";import"./vendor-recharts-Cf84R7xK.js";import"./vendor-db-CxvqBt6T.js";const ze=({devices:l,onImport:C,auditLog:T=[],currentUser:n=null})=>{t.useRef(null);const[I,Fe]=t.useState(me()),[k,Q]=t.useState(I.url||""),[O,Z]=t.useState(I.key||""),[N,q]=t.useState(!1),[D,R]=t.useState(!1),[r,g]=t.useState(null),[y,X]=t.useState(!1),[ee,se]=t.useState(null),[te,U]=t.useState(null),[E,F]=t.useState(!1),[i,B]=t.useState(null),[f,j]=t.useState(null),[A,M]=t.useState(!1),[u,P]=t.useState(!1),[_,z]=t.useState(0),[c,w]=t.useState(null),o=t.useCallback(async()=>{if(!m){j("Cloud neconfigurat");return}M(!0),j(null);const{count:s,error:a}=await be("devices");a?(j(a.message||"eroare necunoscuta"),B(null)):B(s),M(!1)},[]);t.useEffect(()=>{o()},[o,l.length]);const ae=t.useCallback(async()=>{if(l.length===0)return;P(!0),z(0),w(null);const{error:s,written:a}=await he("devices",l,100,d=>z(d));P(!1),w(s?{ok:!1,message:`Urcarea s-a oprit dupa ${a} echipamente: ${s.message||s}`}:{ok:!0,message:`${a} echipamente au fost urcate in cloud. Deschide aplicatia pe celalalt telefon si apasa Re-sincronizare.`}),await o()},[l,o]),le=Te(n,"manageUsers"),[ie,v]=t.useState(()=>b()),[x,H]=t.useState(""),[L,ne]=t.useState("TEHNICIAN"),[p,$]=t.useState(""),re=t.useCallback(()=>{if(!x.trim()||p.length<4){alert("Completeaza numele si un PIN de minim 4 cifre.");return}Ne(x,L,p),v(b()),H(""),$("")},[x,L,p]),ce=t.useCallback(s=>{if(s===(n==null?void 0:n.id)){alert("Nu iti poti sterge propriul cont.");return}window.confirm("Stergi acest utilizator?")&&(ge(s)||alert("Nu poti sterge ultimul administrator."),v(b()))},[n]),oe=t.useCallback(s=>{const a=window.prompt(`PIN nou pentru ${s.name} (minim 4 cifre):`);a&&a.length>=4&&(Ee({...s,pin:a}),v(b()))},[]),Y=`-- MEDITRACK — SCHEMA + MIGRARE (se poate rula de mai multe ori, in siguranta)
